...
TASK_STATUSES = frozenset({TASK_PENDING, TASK_SCHEDULED, TASK_RUNNING, TASK_REVIEWING, TASK_DONE,
                           TASK_CANCELLED, TASK_CONTRACT_REVIEW})
# 看板排序优先级：逾期最前 → 执行中 → 待审核 → 已安排 → 待执行
# → 已完成 → 已取消（值越小越靠前）
TASK_SORT_PRIORITY = {TASK_RUNNING: 1, TASK_REVIEWING: 2, TASK_SCHEDULED: 3,
...
TASK_STATUS_TAG = {
    ...
    TASK_RUNNING: 'primary', TASK_REVIEWING: 'warning',
...
STATUS_CATALOG = {
    ...
    'TASK_STATUS': {
        'values': {
            ...
            'RUNNING': TASK_RUNNING, 'REVIEWING': TASK_REVIEWING,

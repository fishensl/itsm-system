...
ALL_STATUSES = [TASK_PENDING, TASK_SCHEDULED, TASK_RUNNING, TASK_REVIEWING, TASK_RETURNED,
                TASK_DONE, TASK_CANCELLED]
ACTIVE_STATUSES = [TASK_PENDING, TASK_SCHEDULED, TASK_RUNNING, TASK_REVIEWING, TASK_RETURNED, TASK_DONE]
